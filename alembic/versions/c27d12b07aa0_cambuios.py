...
Revision ID: c27d12b07aa0
Revises: fef081bd7945
Create Date: 2025-10-30 23:24:50.725232
"""
...
revision: str = 'c27d12b07aa0'
down_revision: Union[str, None] = 'fef081bd7945'
...
def upgrade() -> None:
    ...
    op.drop_constraint(op.f('metodos_pago_gateway_pago_id_fkey'), 'metodos_pago', type_='foreignkey')
...
def downgrade() -> None:
    ...
    op.create_foreign_key(op.f('metodos_pago_gateway_pago_id_fkey'), 'metodos_pago', 'gateways_metodos_pago', ['gateway_pago_id'], ['id'])
    ...
    sa.Column('nombre_gateway', sa.VARCHAR(), autoincrement=False, nullable=False),
    sa.PrimaryKeyConstraint('id', name=op.f('gateways_metodos_pago_pkey'))
    )
